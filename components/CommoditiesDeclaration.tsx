  ...
  return (
    <div className="space-y-6">
      ...
      <div className="max-w-4xl mx-auto px-2 sm:px-4 lg:px-8 pb-4 sm:pb-8">
        <div className="bg-white rounded-lg shadow-lg p-3 sm:p-4 lg:p-8 space-y-4 sm:space-y-6 lg:space-y-8">
          {/* Title Section */}
          ...
          <div className="bg-red-50 border-2 border-red-500 rounded-lg p-4 sm:p-6">
            <h3 className="text-base sm:text-lg font-bold text-red-800 mb-3 sm:mb-4">BANNED ITEMS</h3>
            <p className="text-xs sm:text-sm text-red-900 font-semibold mb-3 sm:mb-4">
              Please be reminded that the following items are <strong>STRICTLY PROHIBITED</strong> from shipment:
            </p>
            <div className="space-y-1 sm:space-y-2 text-xs sm:text-sm text-red-900">
              <div>• Flammable / Explosive Items</div>
              <div>• Deadly Weapons</div>
              <div>• Illegal Drugs / Vape / Cigarettes / Alcoholic Drinks</div>
              <div>• Expensive / Original Jewelries (gold or silver)</div>
              <div>• Money / Cash</div>
              <div>• Live Animals</div>
              <div>• Frozen Goods / Any Pork Items</div>
              <div>• Medicines / Supplements / Capsules / Vitamins / Injectables</div>
              <div>• Adult Toys</div>
              <div>• Religious Items</div>
              <div>• Long items (more than 200 cm are not allowed)</div>
              <div>• Contact lens / Eye drops / Eye solution</div>
              <div>• Perishable Goods (spoils easily)</div>
            </div>
            <p className="text-xs sm:text-sm text-red-900 font-bold mt-3 sm:mt-4">
              Anything Illegal is <strong>STRICTLY BANNED</strong>.
            </p>
          </div>
          ...
          <div className="space-y-3 sm:space-y-4">
            {/* Title */}
            <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-black">Registered Commodities</h2>
            
            {/* General Error Message */}
            {errors.general && (
              <div className="bg-red-50 border border-red-300 text-red-700 px-3 sm:px-4 py-2 sm:py-3 rounded-lg text-xs sm:text-sm">
                {errors.general}
              </div>
            )}
            ...
            <div className="border border-gray-300 rounded-lg overflow-hidden bg-white">
              {/* Table Header */}
              <div className="bg-green-700 text-white p-3 sm:p-4 flex items-center gap-4">
              ...
              <div className="divide-y divide-gray-200">
                {items.map((item, index) => (
                  <div key={item.id} className="p-3 sm:p-4 flex items-center gap-3 sm:gap-4 bg-white">
            ...
            <div className="flex justify-end gap-2 sm:gap-3 pt-2">
              {items.length > 1 && (
                <button
                  ...
                  className="flex items-center justify-center gap-2 px-4 sm:px-5 py-2 sm:py-2.5 border-2 border-red-500 text-red-500 rounded-lg hover:bg-red-50 active:bg-red-100 transition-colors text-sm sm:text-base font-medium"
                >
              ...
              {items.length < 20 && (
                <button
                  onClick={addItem}
                  className="flex items-center justify-center gap-2 px-4 sm:px-5 py-2 sm:py-2.5 bg-green-700 text-white rounded-lg hover:bg-green-800 active:bg-green-900 transition-colors text-sm sm:text-base font-medium shadow-sm"
                >
