...
export interface BookingPDFData {
  ...
  eidBackImage?: string
  philippinesIdFrontImage?: string
  philippinesIdBackImage?: string
...
export async function generateBookingPDF(data: BookingPDFData, options?: { openInNewTab?: boolean }): Promise<void> {
  ...
  if (data.philippinesIdFrontImage) {
    await addImageToPDF(data.philippinesIdFrontImage, 'Philippines ID - Front')
  }

  if (data.philippinesIdBackImage) {
    await addImageToPDF(data.philippinesIdBackImage, 'Philippines ID - Back')
  }
